...
public class GifController {
    ...
    public ResponseEntity<?> deleteGifFromWishList(@PathVariable("gifId") Long gifId)throws GifNotFoundException {
        try {
    ...
    public ResponseEntity<?> updateCaptionForGif(@RequestBody Gif gif, @PathVariable("gifId") Long gifId)throws GifNotFoundException {
        try {
